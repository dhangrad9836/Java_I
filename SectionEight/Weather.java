public class Weather {
     ...
     */
     ...
     public static void printTemperatures(double farenheit, double celcius){
        System.out.println("The temperature in farenheit is " + farenheit + " and the " +
        "temperature in celsius is " + celcius);
     }
}//Temp class