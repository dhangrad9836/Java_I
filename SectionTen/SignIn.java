...
public class SignIn {
    public static void main(String[] args) {
       ...
       */
        ...
        //pick up password
        userPasswordGuess = scan.nextLine();
       ...
       */
       ...
       while(!username.equals(userNameGuess) || !password.equals(userPasswordGuess) ){
            System.out.println("\nIncorrect, please try again!\n");
            System.out.print("• Username: ");
        //pick up username 
        userNameGuess = scan.next();       
        System.out.print("• Password: ");
        //pick up password
        userPasswordGuess = scan.next();
       }
       System.out.println("\nSign in successful. Welcome!");
